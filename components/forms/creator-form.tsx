...
import { creatorFormSchema, CreatorFormValues } from '@/schema/creator.schema';
...
export function CreatorForm({ onSubmit, isLoading = false, initialData }: CreatorFormProps) {
