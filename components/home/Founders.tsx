      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="md:w-4/12 w-full md:pe-10 md:pt-0 pb-12">
            <Image
              src="/founders-new.jpg"
              alt="Founders of Skillocraft"
              width={500}
              height={500}
          ...
          <div className="md:w-8/12 w-full space-y-4">
            ...
            <p className="text-primary md:text-lg text-sm">
              When the time comes to unveil the visionary minds behind <strong className="font-bold">Skillocraft Pvt. Ltd.</strong>, <strong className="font-bold">Amritendu Chowdhury</strong> stands at the forefront as a key driving force behind the company&apos;s mission and growth.
            </p>
            <p className="text-primary md:text-lg text-sm">
              A B.Tech graduate by qualification, Amritendu embarked on his entrepreneurial journey in 2015 by founding Chowdhury Group of Companies. Through his leadership, the company successfully established itself in the domains of Event Management and Recruitment Services, showcasing his ability to build and scale sustainable business models.
            </p>
            <p className="text-primary md:text-lg text-sm">
              Driven by a passion for innovation and impact, Amritendu envisioned a new-age startup focused on skill development and entrepreneurship creation. This vision led to the foundation of Skillocraft—an initiative aimed at identifying untapped talent and empowering individuals to become successful entrepreneurs across diverse industries.
            </p>
            <p className="text-primary md:text-lg text-sm">
              As the majority shareholder, holding 96% equity, Amritendu plays a pivotal role in shaping the strategic direction, innovation, and long-term vision of <strong className="font-bold">Skillocraft Pvt. Ltd.</strong>
            </p>
            <p className="text-primary md:text-lg text-sm">
              <strong className="font-bold">Sangita Roy</strong>, one of the shareholders of Skillocraft, is a B.Tech graduate and a former employee of BYJU&apos;S. She brings in-depth knowledge and extensive experience in the online education sector. Her expertise and industry exposure are expected to play a significant role in helping Skillocraft achieve its vision and scale effectively in the competitive ed-tech landscape.
            </p>
          </div>
        </div>
      </div>
