    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-sm text-gray-500">Effective as of August 28, 2026</p>
        </div>
      </header>
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="prose max-w-none">
                <section className="mb-8">
                  <p className="text-gray-700">
                    {`This privacy policy applies to the skillocraft app for mobile devices, together with any related services operated by skillocraft (collectively, the "Application"). skillocraft is hereby referred to as the "Service Provider".`}
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700">
                    ...
                    <a href="mailto:contact@skillocraft.com" className="text-indigo-600 hover:text-indigo-500">contact@skillocraft.com</a>.
                  </p>
                </section>

                <section className="mb-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Your California privacy rights (CCPA/CPRA)</h2>
                  <p className="text-gray-700 mb-4">
                ...
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Third Party Access</h2>
                  <p className="text-gray-700">
                ...
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Opt-Out Rights</h2>
                  <p className="text-gray-700 mb-4">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700">
                    ...
                    <a href="mailto:contact@skillocraft.com" className="text-indigo-600 hover:text-indigo-500">contact@skillocraft.com</a>. Please note that some User Provided Data may be required for the Application to function properly.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-700">
                    This privacy policy is effective as of 2026-08-28
                  </p>
                </section>
              ...
              <div className="mt-10 border-t border-gray-200 pt-6">
                <p className="text-sm text-gray-500 text-center">
                  ...
                  <a href="mailto:contact@skillocraft.com" className="text-indigo-600 hover:text-indigo-500">
                    contact@skillocraft.com
                  </a>
                </p>
